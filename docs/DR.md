...
The webhook deploy pipeline runs on the GitOps controller node (CT 102, `192.168.x.8`).
Push to Gitea main branch triggers webhook hooks that auto-deploy changed services.
